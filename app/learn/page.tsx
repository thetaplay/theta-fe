      ...
      <PageLayout title="Learn">
        {isConnected ? (
                      ...
                      <div className="bg-white p-4 border-b border-gray-200/50">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="text-right shrink-0">
                            <div className={`px-2.5 py-1 rounded-lg ${isQuestClaimed ? '' : 'bg-white/80'
                              }`}>
                              <span
                                className={`text-sm font-bold ${isQuestClaimed
                            ...
                            <div className="space-y-2">
                              {quest.steps.map((step, idx) => {
                                ...
                                return (
                                  ...
                                  >
                                    <div
                                      className={`w-5 h-5 rounded flex items-center justify-center shrink-0 ${isCompleted
                                    ...
                                    <span
                                      className={`text-sm font-medium flex-1 ${isCompleted
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                {milestones.map((milestone) => (
                  <div
                    key={milestone.id}
                    className={`rounded-2xl p-4 border-2 transition-all ${milestone.completed
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${milestone.completed ? 'bg-[#4CC658]/20' : 'bg-slate-200/50'
                          }`}
                      >
                        {milestone.completed ? (
                      ...
                      <div className="flex-1">
                        <h4
                          className={`font-bold text-sm ${milestone.completed
          ...
          <div className="text-center py-8">
            <p className="text-muted-foreground text-sm">Please connect your wallet to start learn</p>
          </div>
        )}
      </PageLayout>
