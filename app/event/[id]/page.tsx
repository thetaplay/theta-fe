  ...
  return (
    <IOSPageTransition>
      <div className="w-full h-full flex flex-col">
            ...
            <div className="mb-8">
              ...
              <div className="relative mb-4">
                <input
                  ...
                  style={{
                    background: `linear-gradient(to right, hsl(var(--color-primary) / 0.3) 0%, hsl(var(--color-primary)) ${confidence}%, var(--muted) ${confidence}%, var(--muted) 100%)`,
                  }}
                />
              </div>
        ...
        {/* Bottom Action Bar */}
        <div className="fixed inset-x-0 bottom-0 max-w-[430px] mx-auto bg-background/80 glass border-t px-4 py-3 safe-area-bottom">
          <button
            onClick={handleSubmit}
            disabled={!selectedPrediction || isSubmitting}
            className={`w-full py-4 font-semibold rounded-2xl transition-all duration-200 active:scale-95 ${
