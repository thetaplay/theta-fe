...
import { Search, Bell, DollarSign, TrendingUp, Zap } from 'lucide-react'
...
const EVENTS = [
  ...
  {
    id: '4',
    icon: <DollarSign size={24} fill="currentColor" />,
        ...
        <IOSHeader
          ...
          rightContent={
            <button className="w-10 h-10 rounded-full bg-card border border-border flex items-center justify-center shadow-md active:scale-95 transition-transform">
              <Bell size={20} className="text-foreground" fill="currentColor" />
            </button>
          }
        />
