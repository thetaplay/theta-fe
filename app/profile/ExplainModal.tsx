          ...
          <div className="space-y-6 pb-6">
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Think of this like an insurance policy for your crypto. If the price drops significantly, this position steps in to cover your losses.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Market signals showed some short-term uncertainty. We selected this to help you stay in the game without worrying about sudden dips.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Keep an eye on the "Ends in" timer. As it gets closer to zero, you'll want to decide if you need a new policy or if the coast is clear!
                </p>
              </div>
            </div>
